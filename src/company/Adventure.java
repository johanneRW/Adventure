        ...
        while (gameRunning) {
            ...
            if (command.equals("exit")) {
                ...
                if (answer.equals("yes")) {
                    System.out.println("Sending you back to your hom planet - Goodbye!!!");
                    gameRunning = false;
                ...
                if (currentRoom.getDoorNorth() != null) {
                    ...
                    System.out.println("You can't go that way, ther isn't at teleporter.");
                }
                ...
                if (currentRoom.getDoorEast() != null) {
                    ...
                    System.out.println("You can't go that way, ther isn't at teleporter.y");
                }
                ...
                answer = answer.toLowerCase();
                if (answer.equals("yes")){
                    System.out.println(" Okay, I'll call headquarter to assist.");
